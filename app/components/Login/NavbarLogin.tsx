        ...
        <>
            <nav className="flex flex-row items-center justify-between px-8 py-3 mb-5 w-full fixed bg-background z-50 rounded-b-3xl">
                ...
                <div className="hidden md:block">
                    <Link href="/Signup">
                        <h3 className="font-semibold text-primary border-primary border-2 rounded-full px-2 py-1 text-sm hover:border-none hover:bg-primary hover:text-background hover:py-[6px] hover:px-[10px]">Signup</h3>
                    </Link>
                </div>
